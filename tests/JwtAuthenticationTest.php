...
class JwtBasicAuthenticationTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testShouldCallCallback()
    {
        ...
        $this->assertEquals(self::$token_as_array['iss'], $dummy->getClaim('iss'));
        $this->assertEquals(self::$token_as_array['iat'], $dummy->getClaim('iat'));
        $this->assertEquals(self::$token_as_array['exp'], $dummy->getClaim('exp'));
        $this->assertEquals(self::$token_as_array['aud'], $dummy->getClaim('aud'));
        $this->assertEquals(self::$token_as_array['sub'], $dummy->getClaim('sub'));
        $this->assertEquals(self::$token_as_array['scope'], $dummy->getClaim('scope'));
